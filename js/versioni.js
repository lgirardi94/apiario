// ===== FILE VERSION: 2026-05-28.22 · versioni.js =====
/* ===========================================================
...
const FILE_VERSIONS = {
  // HTML
  'index.html':                { path: 'index.html',            ver: '2026-05-28.28' },
  ...
  'js/insights.js':            { path: 'js/insights.js',        ver: '2026-05-28.6' },
  ...
  'js/versioni.js':            { path: 'js/versioni.js',        ver: '2026-05-28.22' },
};

// Versione "build" complessiva dell'app (la più recente tra tutte)
const APP_BUILD = '2026-05-28.28';
