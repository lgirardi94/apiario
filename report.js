...
function generaReportCompleto() {
  ...
  const sciamiAnno = arnieAttive.filter(a => a.tipo === 'sciame' && a.dataCostituzione && a.dataCostituzione.startsWith(annoStr));
  const nucleiCreatiAnno = arnieAttive.filter(a => (a.tipo === 'nucleo' || a.tipo === 'nucleo_fec') && a.dataCostituzione && a.dataCostituzione.startsWith(annoStr));
